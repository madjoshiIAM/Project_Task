...
{  
	...
	public JSON databaseMonitoring() throws 
	{
		JSONObject obj = new JSONObject();
		obj.put("DatabaseName", "apac_bot_instance");
		obj.put("Connections", new Integer(100));
		obj.put("Active Connection", new Double(1000.21));
		obj.put("Database Size(MB)", new Boolean(true));
		obj.put("Free Memory Space(MB)", new Boolean(true));
		obj.put("CPU Load", mysql.getCPULoadByProcessName("mysqld"));
		return obj;
	}
	...
	{  
		...
		Connection con = mysql.getMySQLconnnection();
		System.out.println("*******************************************************************************");
